...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if(!fc||!bc) return;
    const PAD={l:44,r:16,t:14,b:30}; const dpr=window.devicePixelRatio||1;
    ...
    const iv=setInterval(()=>{if(!running){prog=0;running=true;animate();}},7000);
    return()=>{if(animRef.current)cancelAnimationFrame(animRef.current);clearInterval(iv);};
  },[lambda]);
