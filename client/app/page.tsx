...
export default function Home() {
  return (
    <div style={{ minHeight:"100vh", background:"#0A0B0F", color:"#F1F5F9" }}>
      <nav style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"16px 48px", borderBottom:"1px solid rgba(255,255,255,0.07)", position:"sticky", top:0, background:"rgba(10,11,15,0.95)", zIndex:100 }}>
        <div style={{ fontFamily:"Syne,sans-serif", fontSize:22, fontWeight:800, background:"linear-gradient(135deg,#6C63FF,#22D3EE)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>RecallIQ</div>
      ...
      <section style={{ textAlign:"center", padding:"100px 24px 80px", background:"radial-gradient(ellipse 80% 60% at 50% -10%,rgba(108,99,255,0.15),transparent)" }}>
        ...
        <h1 style={{ fontFamily:"Syne,sans-serif", fontSize:"clamp(38px,6vw,68px)", fontWeight:800, lineHeight:1.1, letterSpacing:-2, marginBottom:22 }}>Stop forgetting<br /><span style={{ background:"linear-gradient(135deg,#6C63FF,#22D3EE)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>what you have learned.</span></h1>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:32, flexWrap:"wrap" }}>
          {[["47k+","Concepts tracked"],["92%","Avg retention rate"],["3.2k","Students using it"]].map(([n,l])=>(
            <div key={l} style={{ textAlign:"center" }}>
              <div style={{ fontFamily:"Syne,sans-serif", fontSize:28, fontWeight:700, color:"#A78BFA" }}>{n}</div>
      ...
      <footer style={{ borderTop:"1px solid rgba(255,255,255,0.07)", padding:"28px 48px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }}>
        <div style={{ fontFamily:"Syne,sans-serif", fontSize:18, fontWeight:800, background:"linear-gradient(135deg,#6C63FF,#22D3EE)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>RecallIQ</div>
